document.addEventListener('DOMContentLoaded', function () {   
    ...
    async function reviews(url) { //asymc/await seguimos usando promesas. Tomaremos distancia del .then(), 'tomamamos distancia de esa forma tradiocional de resolver promesas'
